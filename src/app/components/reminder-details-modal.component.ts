        ...
        <div class="flex flex-col gap-6 pt-2">
          ...
          <div class="flex justify-between items-start gap-4">
            <div class="flex-1 min-w-0">
              ...
              <div class="flex flex-wrap items-center gap-2 mt-1">
                ...
                @if (reminder()?.autoPay) {
                  <app-badge variant="info">Auto-Pay Active</app-badge>
                }
          ...
          <div class="flex flex-col gap-4">
            ...
            @if (subTasks().length > 0) {
              <div class="w-full h-2 bg-gray-100 rounded-full overflow-hidden -mt-1 shadow-inner">
                <div
            ...
            <div class="flex flex-col gap-2.5">
              @for (st of subTasks(); track st) {
                <div class="flex items-center justify-between group bg-white border border-gray-100 p-3 rounded-2xl shadow-sm hover:shadow-md hover:border-primary/20 transition-all">
                  <div
